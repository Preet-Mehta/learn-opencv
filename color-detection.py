...
cv2.createTrackbar("LH", "track", 0, 255, cb)
cv2.createTrackbar("LS", "track", 0, 255, cb)
cv2.createTrackbar("LV", "track", 0, 255, cb)
cv2.createTrackbar("UH", "track", 255, 255, cb)
cv2.createTrackbar("US", "track", 255, 255, cb)
cv2.createTrackbar("UV", "track", 255, 255, cb)
